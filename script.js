...
function exitGame(level) {
  ...
  if (check) {
    if (level === "easy") {
      commonAction("easy", "menu");
    } else if (level === "medium") {
      commonAction("medium", "menu");
    } else {
      commonAction("hard", "menu");
    }
    ...
    if (timeRemain >= 0) {
      if (array.indexOf(size) !== -1) {
        ...
        setTimeout(() => {
          ...
          document.getElementById("your-level").innerHTML = level;
...
function showRankings() {
  ...
  let easyCount = 1,
    ...
    hardCount = 1;
  let easyHtml =
    '<div class="ranking-items"><b>EASY RANK</b></div><div class="ranking-items"><b>NICKNAME</b></div><div class="ranking-items"><b>SCORE</b></div>';
  let mediumHtml =
    '<div class="ranking-items"><b>MEDIUM RANK</b></div><div class="ranking-items"><b>NICKNAME</b></div><div class="ranking-items"><b>SCORE</b></div>';
  let hardHtml =
    '<div class="ranking-items"><b>HARD RANK</b></div><div class="ranking-items"><b>NICKNAME</b></div><div class="ranking-items"><b>SCORE</b></div>';
  userInfor.map((value) => {
